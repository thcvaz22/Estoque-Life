...
const ICONS = {
  ...
  suppliers: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 7h12v10H3z"/><path d="M15 10h3l3 3v4h-6z"/><circle cx="7" cy="19" r="2"/><circle cx="18" cy="19" r="2"/></svg>',
  returns: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 7H4v5"/><path d="M4 12c1.8-4.2 5.1-6 9-6 4.4 0 7 2.6 7 6s-2.6 6-7 6H7"/><path d="m7 14-4 4 4 4"/></svg>',
...
const ROUTES = [
  ...
  { id: 'suppliers', label: 'Fornecedores', icon: 'suppliers', render: renderSuppliers },
  ...
  { id: 'returns', label: 'Devoluções', icon: 'returns', render: renderReturns },
